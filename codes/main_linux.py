...
from PyQt5.QtWidgets import (
    ...
    QLineEdit, QComboBox, QListWidget, QListWidgetItem, QDialog, QTextEdit
)
from pynput import keyboard
from gacha_reroll_linux import GachaAutoThread
from discord_bot import DiscordBotThread
from pause_rules import MinURCountRule, ContainsAnyRule, ContainsAllRule, CompositeRule
...
class MainWindow(QWidget):
    ...
    def initUI(self):
        self.setWindowTitle("BD2 Reroller (Linux)")
    ...
    def check_connect_bot(self):
        try:
            ...
            self.update_connect("Invalid input: Discord User ID must be a number.")
        except Exception as e:
